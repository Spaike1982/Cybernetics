function [Xh,Xb,Yb,Kk,Phat,Pbar,t,cal] = KF2estim(g,x0,Y,dt,tfin)

% KF2estim.m: Kalmanfiter estimation: 
...
% Fuksjonsrutine
%
%   [Xh,Xb,Yb,Kk,Phat,Pbar,t] = KF2estim(g,x0,Y,dt,tfin)
%
